...
public class QueryHelper {
    ...
    /**
     * Returns the integer result (the value of the first column of the first row) of the SELECT COUNT(*) query.
     * @param conn the connection.
     * @param sql the SQL SELECT COUNT(*) query.
     * @param paramsSetter a lambda that will set query parameters to actual values.
     * @return the integer result.
     * @throws SQLException
     */
    public static int count(Connection conn, String sql, StatementParametersSetter paramsSetter) throws SQLException {
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            paramsSetter.setStatementParameters(stmt);
            ResultSet rs = stmt.executeQuery();
            if (rs.next()) {
        ...
        throw new SQLException("SELECT COUNT(*) must always return some number.");
    }
